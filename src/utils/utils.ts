...
const categoryColorMap: Map<CategoryType, string> = new Map([
...
export function setItemCategoryColor(category: CategoryType, el: HTMLElement) {
	for (let val of categoryColorMap.values()) {
		el.classList.remove(val);
	}

	el.classList.add(categoryColorMap.get(category));
}
